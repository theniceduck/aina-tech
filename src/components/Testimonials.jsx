    ...
    <section id='clients' className={`${styles.paddingY} ${styles.flexce} flex-col relative`}>
      <div className='w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]'>
        ...
        <div className='w-full md:mt-0 mt-6'>
          ...
          Hear from our satisfied clients and partners who have experienced our innovative solutions firsthand. Their feedback inspires us to keep delivering excellence and pushing the boundaries of what's possible.
          </p>  
        </div>
      </div>
